...
class Api::V1::MessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_message" do
    assert_difference("Api::V1::Message.count") do
      post api_v1_messages_url, params: { api_v1_message: { content: @api_v1_message.content } }, as: :json
    end
  ...
  test "should update api_v1_message" do
    patch api_v1_message_url(@api_v1_message), params: { api_v1_message: { content: @api_v1_message.content } }, as: :json
    assert_response :success
  end
